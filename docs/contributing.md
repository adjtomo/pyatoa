...
.. note::
    ...
    This contributors guide is modified from `PyGMTs
    <https://github.com/GenericMappingTools/pygmt>`__ guide

This is a community driven project and everyone is welcome to contribute.

The project is hosted on [GitHub](https://github.com/adjtomo/pyatoa)
...
* Provide feedback about how we can improve the project or about your particular use
  case. Open an [issue](https://github.com/adjtomo/pyatoa/issues) with
